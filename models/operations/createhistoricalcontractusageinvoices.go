...
type CreateHistoricalContractUsageInvoicesType string

const (
	CreateHistoricalContractUsageInvoicesTypePrepaid  CreateHistoricalContractUsageInvoicesType = "PREPAID"
	CreateHistoricalContractUsageInvoicesTypePostpaid CreateHistoricalContractUsageInvoicesType = "POSTPAID"
	CreateHistoricalContractUsageInvoicesTypeCredit   CreateHistoricalContractUsageInvoicesType = "CREDIT"
)

func (e CreateHistoricalContractUsageInvoicesType) ToPointer() *CreateHistoricalContractUsageInvoicesType {
	return &e
}
func (e *CreateHistoricalContractUsageInvoicesType) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "POSTPAID":
		fallthrough
	case "CREDIT":
		*e = CreateHistoricalContractUsageInvoicesType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateHistoricalContractUsageInvoicesType: %v", v)
	}
}

// CreateHistoricalContractUsageInvoicesAppliedCommitOrCredit - only present for beta contract invoices
type CreateHistoricalContractUsageInvoicesAppliedCommitOrCredit struct {
	ID   string                                    `json:"id"`
	Type CreateHistoricalContractUsageInvoicesType `json:"type"`
}

func (o *CreateHistoricalContractUsageInvoicesAppliedCommitOrCredit) GetID() string {
	if o == nil {
		return ""
	}
	return o.ID
...
func (o *CreateHistoricalContractUsageInvoicesAppliedCommitOrCredit) GetType() CreateHistoricalContractUsageInvoicesType {
	if o == nil {
		return CreateHistoricalContractUsageInvoicesType("")
	}
	return o.Type
}
...
type CreateHistoricalContractUsageInvoicesTier struct {
	Size       *string `json:"size,omitempty"`
	Level      float64 `json:"level"`
	StartingAt string  `json:"starting_at"`
}

func (o *CreateHistoricalContractUsageInvoicesTier) GetSize() *string {
	if o == nil {
		return nil
	}
	return o.Size
...
func (o *CreateHistoricalContractUsageInvoicesTier) GetLevel() float64 {
	if o == nil {
		return 0.0
	}
	return o.Level
...
func (o *CreateHistoricalContractUsageInvoicesTier) GetStartingAt() string {
	if o == nil {
		return ""
	}
	return o.StartingAt
...
type CreateHistoricalContractUsageInvoicesLineItems struct {
	...
	// only present for beta contract invoices
	AppliedCommitOrCredit *CreateHistoricalContractUsageInvoicesAppliedCommitOrCredit `json:"applied_commit_or_credit,omitempty"`
	// only present for beta contract invoices
	...
	Tier                        *CreateHistoricalContractUsageInvoicesTier `json:"tier,omitempty"`
}
...
func (o *CreateHistoricalContractUsageInvoicesLineItems) GetAppliedCommitOrCredit() *CreateHistoricalContractUsageInvoicesAppliedCommitOrCredit {
	if o == nil {
		return nil
	}
	return o.AppliedCommitOrCredit
}
...
func (o *CreateHistoricalContractUsageInvoicesLineItems) GetTier() *CreateHistoricalContractUsageInvoicesTier {
	if o == nil {
		return nil
	}
	return o.Tier
